...
const MyJobs = ({
  ...
  useEffect(() => {
    if (!sentRequest && job_id_array) {
      getCollection(job_id_array, "jobs");
      setSentRequest(true);
    }
  }, [sentRequest, job_id_array]);

  const showResults = (
    <div class="main-body-container">
      <div class="main-title-wrapper">
        <h3 class="main-title">My vacancies</h3>
      </div>
      <h4 class="main-title-subheading">
        These are the vacancies currently showing on the site. View, edit or
        delete any of your vacancies.
      </h4>
      <div
...
export default connect(mapStateToProps, { getCollection })(MyJobs);
